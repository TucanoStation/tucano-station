ent-ClothingHeadHelmetHardsuitAtmos = capacete de atmos
...
ent-ClothingHeadHelmetHardsuitDeathsquad = capacete do deathsquad
    .desc = Um capacete espacial robusto, feito para operações especiais.
ent-ClothingHeadHelmetHardsuitEngineering = capacete de engenheiro
    .desc = Um capacete espacial, planejado para funcionar em ambientes de baixa pressão e de altas temperaturas.
ent-ClothingHeadHelmetHardsuitEngineeringWhite = capacete do chefe engenheiro
...
ent-ClothingHeadHelmetIHSVoidHelm = capacete de médico
...
ent-ClothingHeadHelmetHardsuitWizard = capacete do mago
...
ent-ClothingHeadHelmetHardsuitCybersun = capacete de juggernaut do Cybersun
